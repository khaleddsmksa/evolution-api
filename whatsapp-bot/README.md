...
## 🔌 ربط البوت بـ Evolution على Docker

إذا كان Evolution API يعمل على **Docker**، راجع الدليل المفصّل خطوة بخطوة في
**[CONNECT.md](./CONNECT.md)** — يشرح حالات الشبكة الأربع (Mac/Windows، Linux،
البوت داخل Docker، ونفق عام) وحلول المشاكل الشائعة.

> 🤖 **للتنفيذ بواسطة وكيل آلي:** يوجد دليل تنفيذ كامل بأوامر جاهزة ومعايير تحقق
> ومعالجة أخطاء في **[AGENT_RUNBOOK.md](./AGENT_RUNBOOK.md)** — مصمّم لتسليمه
> لوكيل (agent) لتنفيذ كافة الأوامر تلقائياً على خادم Ubuntu.
